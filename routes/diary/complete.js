...
router.put('/', upload.single('diary_img'), async(req, res) => {
    ...
    if(req.file == undefined){//이미지 없음
        const updateDiaryResult = await db.queryParam_Parse(updateDiaryQuery,[req.body.diary_content, req.body.weatherIdx, null, req.body.userIdx, req.body.date+'%']);
